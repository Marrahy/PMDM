...
/**
 * Pantalla para seleccionar uno o varios personajes
 *
...
fun TeamScreen(navController: NavController) {
    Scaffold (
                        ...
                        DropdownMenuItem(
                            leadingIcon = {
                                Icon(
                                    ...
                                    contentDescription = "Selector de pantalla"
                                )
                            },
                            text = {
                                Text(
                            ...
                            onClick = {
                                navController.popBackStack(Routes.OnBoardingSelectScreen.route, false)
                            }
                        )
                        DropdownMenuItem(
                            leadingIcon = {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.text_button_select_character),
                fontSize = 25.sp,
